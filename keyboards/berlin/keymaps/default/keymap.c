...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_RALT, KC_RGUI, KC_APP,  KC_RCTL, KC_SLSH, KC_RSFT, RGB_TOG, KC_DOWN, RGB_MODE_RGBTEST, KC_P0,   KC_PDOT //debug layout for rgb testing
